        ...
        questions: [
          {
            ...
            options: [
              ...
              { label: 'B', text: 'Automated Inference' },
              { label: 'C', text: 'Advanced Integration' }
            ],
            correctOption: 'A',
            marks: 10,
            difficulty: 'easy'
        ...
        questions: [
          {
            ...
            type: 'mcq',
            options: [
              { label: 'A', text: 'Random guessing' },
              { label: 'B', text: 'Data they consume' },
              { label: 'C', text: 'Hardware upgrades' }
            ],
            correctOption: 'B',
            marks: 10,
            difficulty: 'easy'
