...
const answerSchema = new mongoose.Schema({
  ...
  type: { type: String, enum: ['mcq', 'short_answer', 'msq', 'true_false'], required: true },
  userAnswer: { type: String }, // User typed answer
  selectedOption: { type: String }, // For MCQ and True/False
  selectedOptions: [{ type: String }], // For MSQ
