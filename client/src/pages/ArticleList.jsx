...
const ArticleList = () => {
  ...
  // ✅ Only published articles will be visible to learners/public users
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Discover new topics and complete assignments.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {publishedArticles.map((article) => (
              <Link
                ...
                key={article._id}
                className="bg-card group hover:shadow-md transition-shadow rounded-xl border border-border overflow-hidden flex flex-col"
              >
                <div className="p-6 flex-1">
                  <div className="flex justify-between items-start mb-4">
                    <span
                      className={`text-xs px-2 py-1 rounded-full font-medium capitalize ${article.difficulty === 'beginner'
